...
public class MediaInfo : IDisposable
{
    ...
    {
        return Marshal.PtrToStringUni(MediaInfo_Get(Handle, MediaInfoStreamKind.General, 0, parameter, MediaInfoInfoKind.Text, MediaInfoInfoKind.Name));
    }
    ...
    public string GetImage(string parameter)
    {
        return Marshal.PtrToStringUni(MediaInfo_Get(Handle, MediaInfoStreamKind.Image, 0, parameter, MediaInfoInfoKind.Text, MediaInfoInfoKind.Name));
    }
